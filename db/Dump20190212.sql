...
--
-- Host: localhost    Database: pantau_dosen
-- ------------------------------------------------------
...
CREATE TABLE `dosen` (
  ...
  `createdDate` datetime DEFAULT NULL COMMENT 'now()',
...
INSERT INTO `dosen` VALUES ('7b2fd503-28fa-11e9-b9f1-0242633a01f6','2018','MEI','JAKARTA','0857123456',NULL,NULL);
...
-- Dump completed on 2019-02-12 17:55:35
